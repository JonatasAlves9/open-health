...
import { TrendingUp, Clock, Layers, Dumbbell, Settings, Activity } from "lucide-react";

export type SectionId = "overview" | "today" | "templates" | "exercises" | "settings";
...
const SECTIONS: Section[] = [
  ...
  { id: "templates",  label: "Treinos salvos",     labelShort: "Treinos",   icon: Layers },
  { id: "exercises",  label: "Exercícios",         labelShort: "Exerc.",    icon: Dumbbell },
    ...
    <aside style={{
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", lineHeight: 1.15, minWidth: 0 }}>
          ...
          <span style={{ fontSize: 13.5, fontWeight: 600, letterSpacing: "-0.01em", color: "var(--oh-fg)" }}>Treinos</span>
        </div>
      </div>
